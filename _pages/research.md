...
Python implementation of nested nonparametric instrumental variables. This package implements methods for estimating nonparametrically nested moment conditions. Related paper: [Meza and Singh](https://arxiv.org/abs/2112.14249).

#### [tot_tut](https://github.com/isaacmeza/tot_tut)
Stata implementation for estimation of treatment-on-the-treated and treatment-on-the-untreated effects using the design in "Structured Payment in Pawnshop Borrowing: Mandates vs. Choice" by DiTraglia, McIntosh, Meza, Seira, and Sadka.
...
Stata implementation of sharp bounds on the distribution of treatment effects of a binary treatment developed in [Fan and Park (2009)](https://doi.org/10.1017/S0266466609990168).
